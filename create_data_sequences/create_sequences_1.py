...
def create_sequences_1_nr(inputs_df, residual_df, config, dataset_dimension, joint_features, target_pose_features, residual_variables, num_joints):
...
def create_sequences_1_wr(inputs_df, residual_df, config, dataset_dimension, joint_features, target_pose_features, residual_variables, num_joints):
