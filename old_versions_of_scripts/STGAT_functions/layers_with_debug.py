...
class TimeBlock(nn.Module):
    ...
    def forward(self, X):
        # X is expected to be in (B, F, N, T)
        print('TimeBlock input X shape:', X.shape)  # Debug print
        out = self.units(X)  # (B, out_channels, N, T_in)
        print('TimeBlock output shape:', out.shape)  # Debug print
        return out