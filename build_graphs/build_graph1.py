...
def build_adjacency_matrix1(config):
    """
...
if __name__ == "__main__":
    ...
    adj_matrix = build_adjacency_matrix1(config)
    np.save('data/adjacency_matrix1.npy', adj_matrix)
    print("Adjacency matrix saved to 'data/adjacency_matrix1.npy'")
